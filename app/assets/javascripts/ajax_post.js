...
//        $("#result").hide("slow");
        if(data.result == 'OK'){
          ...
          $('#result').append(' <a href="https://twitter.com/share" class="twitter-share-button" data-text="ttp://tamakiep.com/unko'+ data.tamaki_url +'/" data-lang="ja" data-size="large" data-count="none" data-hashtags="tamaki_url">ツイート</a>');//完全に邪悪
          twttr.widgets.load();
